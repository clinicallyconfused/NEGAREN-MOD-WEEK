...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
		    ...
		    case 'negaren':
				// Negaren ANIMATION LOADING CODE
				frames = Paths.getSparrowAtlas('characters/negaren');
				animation.addByPrefix('idle', 'Negaren idle', 24, false);
				animation.addByPrefix('singUP', 'Negaren sing up', 24, false);
				animation.addByPrefix('singRIGHT', 'Negaren sing right', 24, false);
				animation.addByPrefix('singDOWN', 'Negaren sing down', 24, false);
				animation.addByPrefix('singLEFT', 'Negaren sing left', 24, false);
